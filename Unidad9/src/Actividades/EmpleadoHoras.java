...
public class EmpleadoHoras extends Empleado {
	...
	public EmpleadoHoras(String primerNombre, String apellidoPaterno, String numeroSeguroSocial, double sueldo, double horas) {
		super(primerNombre, apellidoPaterno, numeroSeguroSocial, sueldo, horas);
	}

	public static void main(String[] args) {
		EmpleadoHoras empleado = new EmpleadoHoras("Juan", "Perez", "123-45- 6789", 15.25, 40);
